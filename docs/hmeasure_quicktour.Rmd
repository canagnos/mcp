...
# train an LDA classifier and predict the labels of the test data
scores.lda <- predict(
  lda(formula=type~., data=pima.train), 
newdata=pima.test)$posterior[,2]
...
# k-NN outputs posterior the winning class, not of class 'Yes'
